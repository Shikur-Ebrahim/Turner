...
if (!admin.apps.length) {
    // User specified path: "C:\Users\shikur\Downloads\serviceAccountKey.json"
    // Using forward slashes for JS string compatibility
    const keyPath = "C:/Users/shikur/Downloads/serviceAccountKey.json";
    ...
    if (fs.existsSync(keyPath)) {
        ...
        console.error(`❌ [Firebase Admin] FATAL: 'serviceAccountKey.json' not found.`);
