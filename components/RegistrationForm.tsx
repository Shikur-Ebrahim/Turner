...
import { Upload, Loader2, Eye, EyeOff, CheckCircle, ChevronDown } from "lucide-react";
...
export default function RegistrationForm() {
    ...
    const [formData, setFormData] = useState({
        password: "",
        confirmPassword: "",
        country: "Ethiopia", // Default
        phonePrefix: "+251", // Default
        phoneNumber: "",
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Sanitize phone number to create a valid email format
            ...
            // 3. Save User Data in Firestore (No Profile Picture)
            await setDoc(doc(db, "users", user.uid), {
                uid: user.uid,
                email: generatedEmail, // Storing generated email
            ...
            <div className="bg-white rounded-t-[3rem] px-8 pt-10 pb-8 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-gray-600 ml-1">Confirm</label>
                            <input
                                type={showPassword ? "text" : "password"}
