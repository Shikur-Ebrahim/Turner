...
export default function AdminChatDashboard() {
    ...
    return (
        <div className="h-screen bg-[#F8F9FD] flex flex-col md:flex-row overflow-hidden relative">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="w-9 h-9 rounded-xl bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-gray-200 transition-colors"
                            >
                                <ChevronLeft size={20} />
                            </button>
