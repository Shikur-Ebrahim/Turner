...
export default function AdminSettings() {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            // Basic normalization if needed, e.g. handle + prefix
            if (!phoneToSearch.startsWith("+")) {
                // Try searching with + if not present, then without
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex">
            ...
            <div className="flex-1 flex flex-col min-h-screen w-full">
                ...
                <header className="sticky top-0 bg-white/80 backdrop-blur-xl px-6 py-6 flex items-center justify-between z-40 border-b border-slate-100">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h2 className="text-xl font-black text-slate-900 tracking-tight leading-none">Account Security</h2>
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">User Restriction Hub</p>
                        </div>
                    </div>
                ...
                <main className="p-4 sm:p-8 max-w-4xl mx-auto w-full space-y-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <div className="flex-1 relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-16 pl-14 pr-6 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:border-indigo-400 focus:bg-white transition-all text-sm font-bold tracking-widest"
                                    />
                                </div>
                                <button
